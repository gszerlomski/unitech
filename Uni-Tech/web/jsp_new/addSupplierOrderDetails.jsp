...
<html>
  ...
  <body>
        ...
        <div class="span9 bs-main-area">
          <div class="row-fluid">
            <div class="span12">
              ...
              <c:if test="${not empty supplierOrderModel}">
                      ...
                      <ul class="custom-content-box">
                        <li>
                          ...
                          <form:form name="orderDetails" id="orderDetails" action="confirmSupplierOrder.htm"
                            method="post" modelAttribute="supplierOrderModel">
    ...
    <form:form id="newOrder" name="newOrderForm" action="newOrder.htm" method="post" modelAttribute="supplierOrderModel">
    </form:form>
  </body>
</html>