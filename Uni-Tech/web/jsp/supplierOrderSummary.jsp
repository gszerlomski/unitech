  ...
  <body>
    <div name="header">
      ...
      <div name="supplierDetails" class="titleBox">
        <p>
          <span class="title" name="supplierName">${orderModel.supplierOrderModel.supplier.supplierName} --
            ${orderModel.supplierOrderModel.orderNumber}</span>
      ...
      <div name="otherDetails" class="mainBox">
        Termin dostarczenia:
        <span class="importantNote">${orderModel.supplierOrderModel.estimatedDeliveryDateString}</span>
      </div>
      <div class="mainBox">
        <a href="javascript:window.print()">
          <img src="images/print.jpg" alt="print this page" id="print-button" />
        </a>
      </div>
  </body>
</html>